...
setup(name = "ner_for_protein_structures",
    ...
    entry_points={
        "console_scripts": [
            "ner_for_protein_structures.get_bioc_xml_from_pmc = bioc_xml_tools.get_bioc_xml_from_pmc:main",
            ...
            "ner_for_protein_structures.pmcxml_to_biocxml = bioc_xml_tools.pmcxml_to_biocxml:main",
            ]
        }
    )
